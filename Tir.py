...
pygame.display.set_caption('Parabole de tir')

# Constantes
g = 9.81  # Accélération due à la gravité (m/s²)

# Valeurs par défaut pour la vitesse initiale et l'angle
vitesse_initiale = 50  # Vitesse de départ du tir en m/s
angle_initial = 45  # Angle de départ du tir en degrés
